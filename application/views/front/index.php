...
<div class="col-sm-4 col-sm-offset-8 kotak" style="margin-top:10px">
		<button type="submit" class="btn" style="background-color:#42e200; border-radius: 100px; font-size: 25px;font-family: Arial;font-style: italic; color:#ffffff;    position: absolute;
